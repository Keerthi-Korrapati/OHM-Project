...
public class InventoryReportsController {
    ...
    public ResponseEntity<InventoryReports> getinventory(@PathVariable(value = "id") int  inReportsId)
    ...
    public ResponseEntity<InventoryReports> updateInventory(@PathVariable(value = "id") int  inReportsId,
    ...
    public Map<String,Boolean> deleteEmployee(@PathVariable(value = "id") int  inReportsId)throws ResourceNotFoundException {
        InventoryReports inventoryReports=inventoryReportsRepository.findById(inReportsId)
                .orElseThrow(() -> new ResourceNotFoundException("Inventory not found for this id :: " +inReportsId ));
